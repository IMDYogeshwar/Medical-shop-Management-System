...
String companyName,country,email,contactNo,address;
 String tableClicked = "";
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(318, 318, 318)
                .addComponent(searchTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 363, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
     try{
        String sql = "SELECT  company_name as 'company Name',country as 'country',email as 'email',contact_no as 'contact no',address as 'address' FROM company WHERE company_name LIKE '%"+ searchTxt.getText() +"%'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
