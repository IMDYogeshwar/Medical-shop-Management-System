   ...
   public void close(){
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
         try{
           ...
           String sl = "SELECT * FROM company";
          PreparedStatement  ps = conn.prepareStatement(sl);
          ResultSet r= ps.executeQuery();
          String s = null;
          if(r.next()){
             s="update products set company_name='"+companyNameTxt.getText()+"' where company_name='"+r.getString("company_name")+"'";
             PreparedStatement p = conn.prepareStatement(s);
             p.execute();
          }
          
          
           sl = "SELECT * FROM sales_record";
            ps = conn.prepareStatement(sl);
           r= ps.executeQuery();
           s = null;
          if(r.next()){
             s="update sales_record set company_name='"+companyNameTxt.getText()+"' where company_name='"+r.getString("company_name")+"'";
             PreparedStatement p = conn.prepareStatement(s);
             p.execute();
          }
