   ...
   public void close(){
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
         try{
          ...
          String s = null;
          if(r.next()){
             s="update company set company_name='"+companyNameTxt.getText()+"' where company_name='"+r.getString("company_name")+"'";
           ...
           s = null;
          if(r.next()){
             s="update sales_record set company_name='"+companyNameTxt.getText()+"' where product_name='"+r.getString("product_name")+"'";
             PreparedStatement p = conn.prepareStatement(s);
             p.execute();
          }
